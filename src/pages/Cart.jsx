...
export default function Cart() {
  ...
  return (
    <div className="py-[40px] px-[48px] w-[973px]">
      <h1 className="text-[48.83px]">Check your Bag Items</h1>
      ...
      <div className="mt-8.5 ">
        ...
        {productsCart.length === 0 ? (
          ...
          productsCart.map((product, idx) => (
            <div
              key={idx}
              className="grid md:grid-cols-[auto_1fr] mb-[24px] bg-white rounded-[21px] pt-4 pb-4.5 px-6"
            >
              {/* left-image */}
